...
for m in range(len(var1a)):
    for n in range(len(var2a)):
        ...
        if (m == 0) & (n == 0):
            ...
            freqtemp = list(freqsolve)[
                0
            ]  # this needs to solve for remainder to work, if it doesn't solve, error is returned
...
data.create_channel(name="w3freq", values=ch1.T)
data.create_channel(name="test", values=test1.T)
